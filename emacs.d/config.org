...
#+begin_src emacs-lisp :tangle no
  ...
  (defun abrampers/set-js-indentation ()
    (setq-default js-indent-level 2)
    (setq evil-shift-width js-indent-level)
    (setq tab-width 2))

  (add-to-list 'magic-mode-alist '("#!/user/bin/env node" . js-mode))
  (add-hook 'js-mode-hook #'abrampers/set-js-indentation)
  (add-hook 'json-mode-hook #'abrampers/set-js-indentation)
  (add-hook 'js-mode-hook 'electric-pair-local-mode)
  ;; (add-hook 'before-save-hook #'lsp-format-buffer)
  ;; (add-hook 'before-save-hook #'lsp-organize-imports)

  (defun abrampers/set-eslint-config()
