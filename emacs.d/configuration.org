...
#+end_src
*** TODO Remove if =no-littering= is working just fine
...
#+end_src
*** TODO Move directories to private folder
...
***** TODO add wrapper to run this command after projectile is loaded
