...
These templates is created to write code blocks faster in org files.
...
* Sync Emacs Environment Variables

When running emacs from the app, emacs won't have the user's shell environment variable. =exec-path-from-shell= will help us to sync user shell's environment variable with emacs environment variable.
...
** TODO Make sure emacs won't clutter working tree
...
*** TODO Move =Documents/projects= and =Documents/source.golabs.io= to =Code/=
...
Forge is used to integrate with GitHub and GitLab from emacs.
#+begin_src emacs-lisp :tangle no
...
This configuration uses [[https://evil.readthedocs.io/en/latest/index.html][evil-mode]] for a Vi-like modal editing experience.  [[https://github.com/noctuid/general.el][general.el]] is used for easy keybinding configuration that integrates well with which-key.  [[https://github.com/emacs-evil/evil-collection][evil-collection]] is used to automatically configure various Emacs modes with Vi-like keybindings for evil-mode.  [[https://github.com/emacs-evil/evil-magit][evil-magit]] is used to configure Magit and Evil to play well with each other.
...
** TODO supress error on =evil-want-keybindings=

** TODO Remap ctrl to caps lock

** TODO Add vim like keybindings
