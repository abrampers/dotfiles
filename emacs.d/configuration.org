...
*** TODO Add something like =gitgutter= for modified lines.
...
[[https://github.com/clojure-emacs/clojure-mode/][clojure-mode]] for =.clj= languages. For lsp integration, make sure [[https://github.com/snoe/clojure-lsp][clojure-lsp]] is configured properly.
